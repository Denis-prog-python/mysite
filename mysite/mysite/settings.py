...
Generated by 'django-admin startproject' using Django X.XX.
...
BASE_DIR = Path(__file__).resolve().parent.parent  # Определяем BASE_DIR
...
INSTALLED_APPS = [
    ...
    'myapp',  # Названия твоих приложений
]
